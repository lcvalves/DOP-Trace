 ...
 * @param {org.example.basic.setupDemo} setupDemo The sample transaction instance.
 * @transaction
 */
...
/**
 * Sample transaction processor function.
 * @param {org.example.basic.A_producerToLogistics} prodToLog The sample transaction instance.
 * @transaction
 */
async function prodToLog(prodToLog) { 
    return getAssetRegistry('org.example.basic.LogisticsCompany').then(function(playerRegistry){
       return playerRegistry.exists(prodToLog.newOwner.getIdentifier())
   }).then(function(exists) {
       return getAssetRegistry('org.example.basic.Producer')
       .then(function(playerRegistryHarvest){
           return playerRegistryHarvest.exists(prodToLog.issuer.getIdentifier())
             ...
             return getAssetRegistry('org.example.basic.Batch')
           .then(function(playerRegistryBatch){
               ...
               if(!exists) {
                 ...
                 throw Error('Lote não registado!')
                     ...
                     getAssetRegistry('org.example.basic.Batch')
...
/**
 * Sample transaction processor function.
 * @param {org.example.basic.B_logisticsToIndustry} logisticsToIndustry The sample transaction instance.
 * @transaction
 */

async function logisticsToIndustry(logisticsToIndustry) { 
    return getAssetRegistry('org.example.basic.Industry_Retailer').then(function(playerRegistry){
       return playerRegistry.exists(logisticsToIndustry.newOwner.getIdentifier())
   }).then(function(exists) {
       return getAssetRegistry('org.example.basic.LogisticsCompany')
       .then(function(playerRegistryHarvest){
...
/**
 * Sample transaction processor function.
 * @param {org.example.basic.C_batchRegistration} batchRegistration The sample transaction instance.
 * @transaction
 */

async function batchRegistration(batchRegistration) {

    return getAssetRegistry('org.example.basic.Industry_Retailer')
    	...
    	.then(function(playerRegistryBatch){
           return playerRegistryBatch.exists(batchRegistration.batch.getIdentifier())
                ...
                if(!exists && existsHarvest)  {
                 ...
                 let result = await getAssetRegistry('org.example.basic.Batch')
                                    ...
                                    for (i = 1; i <= numberOfBatch; i++) {
                                        ...
                                        let batch = factory.newResource('org.example.basic', 'Batch', batchRegistration.batch.id + 'SubBatch' + random);
...
/**
 * Sample transaction processor function.
 * @param {org.example.basic.D_industryToEntity} industryToEntity The sample transaction instance.
 * @transaction
 */

async function industryToEntity(industryToEntity) { 
    return getAssetRegistry('org.example.basic.CertificationEntity').then(function(playerRegistry){
...
/**
 * Sample transaction processor function.
 * @param {org.example.basic.E_EntityToIndustry} entityToIndustry The sample transaction instance.
 * @transaction
 */
...
async function entityToIndustry(entityToIndustry) { 
    return getAssetRegistry('org.example.basic.Industry_Retailer').then(function(playerRegistry){
       ...
       return getAssetRegistry('org.example.basic.CertificationEntity')
       .then(function(playerRegistryHarvest){
...
/**
 * Sample transaction processor function.
 * @param {org.example.basic.F_EntityToLogistics} entityToLogistics The sample transaction instance.
 * @transaction
 */
...
/**
 * Sample transaction processor function.
 * @param {org.example.basic.query} query The sample transaction instance.
 * @transaction
 */

async function query(query) {

    let assetRegistry = await getAssetRegistry('org.example.basic.Events');
