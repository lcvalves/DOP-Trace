...
function setupDemo(setupDemo) {
    ...
    var logisticsContacts = factory.newConcept(NS, 'Contacts');
    logisticsContacts.phoneNumber = "955555555";
    logisticsContacts.email = "logistics@email.com";
    var logisticsAddress = factory.newConcept(NS, 'Address');
    logisticsAddress.street = "Rua do transporte";
    logisticsAddress.zip = "4900-100";
    logisticsAddress.city = "Viana do Castelo";
    logisticsAddress.country = "Portugal";
