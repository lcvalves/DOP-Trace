...
@Component({
  selector: 'app-transactionsale',
  templateUrl: './transactionSale.component.html',
  styleUrls: ['./transactionSale.component.css'],
  providers: [transactionSaleService]
})
export class transactionSaleComponent implements OnInit {
  ...
  loadAll(): Promise<any> {
    const tempList = [];
    return this.servicetransactionSale.getAll()
    .toPromise()
    .then((result) => {
  ...
  getForm(id: any): Promise<any> {
    ...
    return this.servicetransactionSale.getTransaction(id)
    .toPromise()
    .then((result) => {
      this.errorMessage = null;
      const formObject = {
