...
@Component({
  ...
  templateUrl: './transactionDiscard.component.html',
  styleUrls: ['./transactionDiscard.component.css'],
  providers: [transactionDiscardService]
})
export class transactionDiscardComponent implements OnInit {
  ...
  loadAll(): Promise<any> {
    const tempList = [];
    return this.servicetransactionDiscard.getAll()
    .toPromise()
    .then((result) => {
  ...
  getForm(id: any): Promise<any> {
    ...
    return this.servicetransactionDiscard.getTransaction(id)
    .toPromise()
    .then((result) => {
      this.errorMessage = null;
      const formObject = {
