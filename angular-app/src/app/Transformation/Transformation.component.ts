...
export class TransformationComponent implements OnInit {
  ...
  constructor(public serviceTransformation: TransformationService, fb: FormBuilder) {
  ...
  loadAll(): Promise<any> {
    const tempList = [];
    return this.serviceTransformation.getAll()
    .toPromise()
    .then((result) => {
  ...
  addAsset(form: any): Promise<any> {
    this.asset = {
      ...
      'processes': this.processes.value,
    ...
    return this.serviceTransformation.addAsset(this.asset)
    .toPromise()
    .then(() => {
      this.errorMessage = null;
      this.myForm.setValue({
  ...
  updateAsset(form: any): Promise<any> {
    ...
    return this.serviceTransformation.updateAsset(form.get('id').value, this.asset)
    .toPromise()
    .then(() => {
      this.errorMessage = null;
      this.loadAll();
  ...
  deleteAsset(): Promise<any> {
    ...
    return this.serviceTransformation.deleteAsset(this.currentId)
    .toPromise()
    .then(() => {
      this.errorMessage = null;
      this.loadAll();
  ...
  getForm(id: any): Promise<any> {
    ...
    return this.serviceTransformation.getAsset(id)
    .toPromise()
    .then((result) => {
      this.errorMessage = null;
      const formObject = {
      ...
      if (result.processes) {
        formObject.processes = result.processes;
      } else {
        formObject.processes = null;
      }
      ...
      if (result.usedBatches) {
        formObject.usedBatches = result.usedBatches;
      } else {
        formObject.usedBatches = null;
      }
