...
export class DiscardComponent implements OnInit {
  ...
  constructor(public serviceDiscard: DiscardService, fb: FormBuilder) {
  ...
  loadAll(): Promise<any> {
    const tempList = [];
    return this.serviceDiscard.getAll()
    .toPromise()
    .then((result) => {
  ...
  addAsset(form: any): Promise<any> {
    this.asset = {
      ...
      'discardedBatches': this.discardedBatches.value,
      'id': this.id.value,
    ...
    return this.serviceDiscard.addAsset(this.asset)
    .toPromise()
    .then(() => {
      this.errorMessage = null;
      this.myForm.setValue({
  ...
  updateAsset(form: any): Promise<any> {
    ...
    return this.serviceDiscard.updateAsset(form.get('id').value, this.asset)
    .toPromise()
    .then(() => {
      this.errorMessage = null;
      this.loadAll();
  ...
  deleteAsset(): Promise<any> {
    ...
    return this.serviceDiscard.deleteAsset(this.currentId)
    .toPromise()
    .then(() => {
      this.errorMessage = null;
      this.loadAll();
  ...
  getForm(id: any): Promise<any> {
    ...
    return this.serviceDiscard.getAsset(id)
    .toPromise()
    .then((result) => {
      this.errorMessage = null;
      const formObject = {
      ...
      if (result.motive) {
        formObject.motive = result.motive;
      } else {
        formObject.motive = null;
      }
      ...
      if (result.discardedBatches) {
        formObject.discardedBatches = result.discardedBatches;
      } else {
        formObject.discardedBatches = null;
      }
