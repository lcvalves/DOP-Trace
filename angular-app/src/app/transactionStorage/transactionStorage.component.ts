...
@Component({
  selector: 'app-transactionstorage',
  templateUrl: './transactionStorage.component.html',
  styleUrls: ['./transactionStorage.component.css'],
  providers: [transactionStorageService]
})
export class transactionStorageComponent implements OnInit {
  ...
  loadAll(): Promise<any> {
    const tempList = [];
    return this.servicetransactionStorage.getAll()
    .toPromise()
    .then((result) => {
  ...
  getForm(id: any): Promise<any> {
    ...
    return this.servicetransactionStorage.getTransaction(id)
    .toPromise()
    .then((result) => {
      this.errorMessage = null;
      const formObject = {
